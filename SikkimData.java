...
public class SikkimData extends JFrame {
    private JTextArea textArea;

   
    public SikkimData(String district) {
    	setTitle("Sikkim Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/sikkim";
        ...
        try {
            ...
            String sqlQuery = "Select * from sikkim.tourist_spots";
            ...
            while (resultSet.next()) {
                String cityName = resultSet.getString("nearest_railway_station");
//                
