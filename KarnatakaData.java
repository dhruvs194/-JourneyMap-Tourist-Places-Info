...
public class KarnatakaData extends JFrame {
    private JTextArea textArea;

   
    public KarnatakaData(String district) {
    	setTitle("Karnataka Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/Karnataka";
        ...
        try {
            ...
            String sqlQuery = "Select * from Karnataka.tourist_spots";
