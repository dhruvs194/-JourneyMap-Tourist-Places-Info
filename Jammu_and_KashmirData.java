...
public class Jammu_and_KashmirData extends JFrame {
    private JTextArea textArea;

   
    public Jammu_and_KashmirData(String district) {
    	setTitle("Jammu and Kashmir Data");
    	setSize(600, 400);
    	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    	textArea = new JTextArea(20, 40);
    	textArea.setEditable(false);
    	textArea.setBackground(Color.YELLOW); // Set the background color to orange
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/jammukashmir";
        ...
        try {
            ...
            String sqlQuery = "Select * from jammukashmir.tourist_spots";
