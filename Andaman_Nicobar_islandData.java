...
public class Andaman_Nicobar_islandData extends JFrame {
    private JTextArea textArea;

   
    public Andaman_Nicobar_islandData(String district) {
    	setTitle("Andaman Nicobar Island Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/Andaman_Nicobar_Island";
        ...
        try {
            ...
            String sqlQuery = "Select * from Andaman_Nicobar_Island.tourist_spots";
            ...
            while (resultSet.next()) {
                String cityName = resultSet.getString("place_name");
//                
                ...
                if(cityName.equals(district)) {
                	...
                	String neareststationdistance = resultSet.getString("distance_from_nearest_railway_station");
                	String besttimetovisit = resultSet.getString("best_time_to_visit");
                	String activities = resultSet.getString("adventures");
