...
public class Himachal_PradeshData extends JFrame {
    private JTextArea textArea;

   
    public Himachal_PradeshData(String district) {
    	setTitle("Himachal Pradesh Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/Himachal_pradesh";
        ...
        try {
            ...
            String sqlQuery = "Select * from Himachal_pradesh.tourist_spots";
