...
public class UttarPradeshData extends JFrame {
    private JTextArea textArea;

   
    public UttarPradeshData(String district) {
    	setTitle("UttarPradesh Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/up";
        ...
        try {
            ...
            String sqlQuery = "Select * from up.tourist_spots";
