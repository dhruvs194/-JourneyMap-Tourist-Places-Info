...
public class GujaratData extends JFrame {
    private JTextArea textArea;

   
    public GujaratData(String district) {
    	setTitle("Gujarat Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/Gujrat";
        ...
        try {
            ...
            String sqlQuery = "Select * from Gujrat.tourist_spots";
