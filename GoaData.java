...
public class GoaData extends JFrame {
    private JTextArea textArea;

   
    public GoaData(String district) {
    	setTitle("Goa Data");
    	setSize(600, 400);
    ...
    private void fetchAndDisplayData(String district) {
        String dbUrl = "jdbc:mysql://localhost:3306/goa";
        ...
        try {
            ...
            String sqlQuery = "Select * from goa.tourist_spots";
